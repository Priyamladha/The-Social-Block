    ...
    <div style="display: flex; flex-direction: column;">
      ...
      <div id="upload">
        <div v-if="this.$root.$data.loading === false">
          <h1>Welcome to The Social Block</h1>
          <p style="text-align:right;font-size:13px;">powered by blockchain</p>
          <h4>Share your best moments here</h4>
          ...
          >
            <div>
              <b-form-file
                ...
                placeholder="Choose an image or a gif or drop it here..."
